...
export default function Footer() {
  return (
    <section className="mt-10 bg-background text-foreground">
      <div className="mx-auto w-full max-w-7xl px-4 py-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <form
            className="flex w-full max-w-xl items-stretch overflow-hidden rounded-md border border-border bg-card text-foreground"
            onSubmit={(e) => e.preventDefault()}
          >
            <input
              type="email"
              placeholder="Email..."
              className="w-full flex-1 bg-transparent px-3 py-2 text-sm outline-none placeholder:text-muted-foreground"
              aria-label="Email"
            />
            <button
              type="submit"
        ...
        <div className="mt-6 flex flex-col items-start justify-between gap-4 border-t border-border pt-4 text-sm md:flex-row md:items-center">
